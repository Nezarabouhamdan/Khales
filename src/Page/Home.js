...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Home - Khales</title>
        <meta
          name="description"
          content="Welcome to Khales. Explore our luxury design and project management solutions."
        />
      </Helmet>
      <section>
        <HeroSlider
        ...
        {/* <AboutSection /> */}
        <ServicesSwiper />
        {/* <div style={{backgroundColor:'black'}}> <PassionsSection /></div>    */}
        <FeaturedProjects />
        {/* <Process />
      <BespokeDesign/> */}
        <TestimonialSlider />
