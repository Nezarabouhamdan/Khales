  ...
  ar: [
    {
      ...
      green: "الشركة",
      content:
        "فخالص لإدارة المشاريع هي بوابتك لتحويل الأفكار إلى واقع ملموس. نحن متخصصون في الهندسة المعمارية، الإنشاءات، والتشطيبات الداخلية، حيث نقدم حلولًا متكاملة تناسب المشاريع الفاخرة، المساحات التجارية، والتطويرات السكنية. بفضل الدقة، الكفاءة، والابتكار، نضمن لك تنفيذًا سلسًا يتخطى التوقعات. مع فريق متمرس مكرّس لرؤيتك، نلتزم بتقديم نتائج استثنائية دون تأخير أو تنازلات—فقط إبداع، جودة، وإنجازات تدوم.",
      button: "أعرف المزيد",
    },
  ],
};
